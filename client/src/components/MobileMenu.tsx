...
const MobileMenu = ({ isOpen, onClose }: MobileMenuProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={menuRef}
        className="absolute inset-y-0 left-0 w-64 bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl shadow-xl transform transition-transform duration-300 ease-in-out"
      >
